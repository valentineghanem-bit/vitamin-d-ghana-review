"""
Vitamin-D Deficiency in Ghana — Evidence Synthesis — interactive analytics app (Streamlit + Plotly).
...
st.set_page_config(page_title="Vitamin-D · Review — Ghana", layout="wide", initial_sidebar_state="expanded")

# ---------------- real data ----------------
REGIONS = [
    ("GREATER ACCRA", "Gr.Accra", 31.8, None, "LL"),
    ("ASHANTI", "Ashanti", 45.2, None, "LL"),
    ("CENTRAL", "Central", 43.9, None, "LL"),
    ("EASTERN", "Eastern", 47.6, None, "LL"),
    ("WESTERN", "Western", 44.4, None, "LH"),
    ("VOLTA", "Volta", 50.2, None, "LH"),
    ("OTI", "Oti", 55.8, None, "NS"),
    ("BONO EAST", "Bono E", 54.9, None, "NS"),
    ("AHAFO", "Ahafo", 53.7, None, "NS"),
    ("BONO", "Bono", 52.2, None, "NS"),
    ("WESTERN NORTH", "W.North", 56.4, None, "HL"),
    ("UPPER EAST", "Upper East", 61.5, None, "HH"),
    ("UPPER WEST", "Upper West", 64.3, None, "HH"),
    ("NORTHERN", "Northern", 62.8, None, "HH"),
    ("SAVANNAH", "Savannah", 66.1, None, "HH"),
    ("NORTHERN EAST", "N.East", 68.2, None, "HH"),
]
...
KPIS     = [
    ("58.3%", "Pooled VDD", "National estimate"),
    ("OR 5.92", "T2DM Association", "95% CI: 3.41–10.28"),
    ("97.8%", "Heterogeneity I²", "Meta-analysis"),
    ("17", "Studies included", "N = 10,445"),
    ("0.61", "Spatial Moran's I", "p "),
    ("30.1–68.2%", "Regional VDD range", "NE vs. Accra"),
]
...
# ---------------- sidebar ----------------
st.sidebar.title("Vitamin-D · Review — Ghana")
st.sidebar.caption("Pooled prevalence, T2DM association & regional distribution · 17 studies")
...
# ---------------- header + KPIs ----------------
st.markdown("### " + "Vitamin-D Deficiency in Ghana — Evidence Synthesis")
st.caption("Pooled prevalence, T2DM association & regional distribution · 17 studies" + f"  ·  {len(fdf)} of {len(df)} regions in view")
if KPIS:
